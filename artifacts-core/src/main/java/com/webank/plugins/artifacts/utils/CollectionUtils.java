...
public class CollectionUtils {
    ...
    public static <G, E> List<G> groupUp(List<G> groups,
        ...
        if (keyMapperOfGroup == null)
            throw new PluginException("Key mapper of Group Object cannot be null for grouping function.");
        if (childrenMapperOfGroup == null)
            throw new PluginException("Children mapper of Group Object cannot be null for grouping function.");
        if (parentMapperOfElement == null)
            throw new PluginException("Parent mapper of Element Object cannot be null for grouping function.");
        ...
        elements.forEach(element -> {
            ...
            if (children == null)
                throw new PluginException("Children property should not be null.");
