...
CMD ["/bin/sh","-c","/scripts/start.sh $WECUBE_PLATFORM_SERVER_URL $WECMDB_SERVER_URL $SALTSTACK_SERVER_URL $ARTIFACTS_S3_SERVER_URL $ARTIFACTS_S3_ACCESS_KEY $ARTIFACTS_S3_SECRET_KEY"]
