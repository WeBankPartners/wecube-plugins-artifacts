...
[增加属性](images/image1.png)
[增加属性](images/image2.png)
[增加属性](images/image3.png)
[增加属性](images/image4.png)
[增加属性](images/image5.png)

- 【子系统设计】详细参数如上，直接按照上面的填写并提交

4. **删除属性**：删除其中的【单元设计】属性
[增加属性](images/image6.png)

5. **修改变量名称**：将【变量名称】中的 【是否唯一】改成 【NO】，模型配置修改完毕
[增加属性](images/image7.png)

6. **修改唯一名称**：将【唯一名称】中的这几个参数进行对应修改
[增加属性](images/image8.png)

7. **修改唯一名称**：在 协同-插件注册 页面，进入 wecmdb 插件（注意：是wecmdb插件，不是物料包插件）
[增加属性](images/image9.png)
- 点击下面的配置icon 进入 【数据模型】页面
[增加属性](images/image10.png)
